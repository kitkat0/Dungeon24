...
// constexpr to turn our patterns into std::array<int, N>. -1 denotes a '?'
//https://github.com/cristeigabriel/compiletime-string-to-bytearray/blob/main/compiletime-string-to-bytearray.cpp
