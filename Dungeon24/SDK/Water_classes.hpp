...
{
public:
	class UBodySetup*                             CachedBodySetup;                                   // 0x0540(0x0008)(ZeroConstructor, NoDestructor, NonPIEDuplicateTransient, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(offsetof(ULakeCollisionComponent, CachedBodySetup) == 0x000540, "Member 'ULakeCollisionComponent::CachedBodySetup' has a wrong offset!");
static_assert(offsetof(ULakeCollisionComponent, BoxExtent) == 0x000548, "Member 'ULakeCollisionComponent::BoxExtent' has a wrong offset!");
...
static_assert(offsetof(UOceanCollisionComponent, CachedBodySetup) == 0x000540, "Member 'UOceanCollisionComponent::CachedBodySetup' has a wrong offset!");
...
static_assert(sizeof(AWaterBody) == 0x0002C8, "Wrong size on AWaterBody");
...
{
public:
	class UPhysicalMaterial*                      PhysicalMaterial;                                  // 0x0540(0x0008)(Edit, ZeroConstructor, DisableEditOnInstance, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UWaterBodyComponent, PhysicalMaterial) == 0x000540, "Member 'UWaterBodyComponent::PhysicalMaterial' has a wrong offset!");
static_assert(offsetof(UWaterBodyComponent, TargetWaveMaskDepth) == 0x000548, "Member 'UWaterBodyComponent::TargetWaveMaskDepth' has a wrong offset!");
static_assert(offsetof(UWaterBodyComponent, MaxWaveHeightOffset) == 0x00054C, "Member 'UWaterBodyComponent::MaxWaveHeightOffset' has a wrong offset!");
...
static_assert(sizeof(AWaterBodyCustom) == 0x0002C8, "Wrong size on AWaterBodyCustom");
...
static_assert(sizeof(AWaterBodyLake) == 0x0002C8, "Wrong size on AWaterBodyLake");
...
static_assert(sizeof(AWaterBodyOcean) == 0x0002C8, "Wrong size on AWaterBodyOcean");
...
static_assert(sizeof(AWaterBodyRiver) == 0x0002C8, "Wrong size on AWaterBodyRiver");
...
public:
	...
	struct FIntPoint                              ExtentInTiles;                                     // 0x0590(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_598[0x98];                                     // 0x0598(0x0098)(Fixing Size After Last Property [ Dumper-7 ])
	TSet<class UMaterialInterface*>               UsedMaterials;                                     // 0x0630(0x0050)(Transient, TextExportTransient, NonPIEDuplicateTransient, UObjectWrapper, NativeAccessSpecifierPrivate)
	uint8                                         Pad_680[0x10];                                     // 0x0680(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         TessellationFactor;                                // 0x0690(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	float                                         LODScale;                                          // 0x0694(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UWaterMeshComponent) == 0x0006A0, "Wrong size on UWaterMeshComponent");
static_assert(offsetof(UWaterMeshComponent, ForceCollapseDensityLevel) == 0x000578, "Member 'UWaterMeshComponent::ForceCollapseDensityLevel' has a wrong offset!");
static_assert(offsetof(UWaterMeshComponent, FarDistanceMaterial) == 0x000580, "Member 'UWaterMeshComponent::FarDistanceMaterial' has a wrong offset!");
static_assert(offsetof(UWaterMeshComponent, FarDistanceMeshExtent) == 0x000588, "Member 'UWaterMeshComponent::FarDistanceMeshExtent' has a wrong offset!");
static_assert(offsetof(UWaterMeshComponent, TileSize) == 0x00058C, "Member 'UWaterMeshComponent::TileSize' has a wrong offset!");
static_assert(offsetof(UWaterMeshComponent, ExtentInTiles) == 0x000590, "Member 'UWaterMeshComponent::ExtentInTiles' has a wrong offset!");
static_assert(offsetof(UWaterMeshComponent, UsedMaterials) == 0x000630, "Member 'UWaterMeshComponent::UsedMaterials' has a wrong offset!");
static_assert(offsetof(UWaterMeshComponent, TessellationFactor) == 0x000690, "Member 'UWaterMeshComponent::TessellationFactor' has a wrong offset!");
static_assert(offsetof(UWaterMeshComponent, LODScale) == 0x000694, "Member 'UWaterMeshComponent::LODScale' has a wrong offset!");
...
static_assert(offsetof(UWaterSplineComponent, WaterSplineDefaults) == 0x000640, "Member 'UWaterSplineComponent::WaterSplineDefaults' has a wrong offset!");
static_assert(offsetof(UWaterSplineComponent, PreviousWaterSplineDefaults) == 0x000650, "Member 'UWaterSplineComponent::PreviousWaterSplineDefaults' has a wrong offset!");
...
public:
	...
	struct FVector                                TessellatedWaterMeshExtent;                        // 0x02E0(0x0018)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint32                                        NonTessellatedLODSectionScale;                     // 0x02F8(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	...
	bool                                          bEnableNonTessellatedLODMesh;                      // 0x0300(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_301[0x27];                                     // 0x0301(0x0027)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(AWaterZone, TessellatedWaterMeshExtent) == 0x0002E0, "Member 'AWaterZone::TessellatedWaterMeshExtent' has a wrong offset!");
static_assert(offsetof(AWaterZone, NonTessellatedLODSectionScale) == 0x0002F8, "Member 'AWaterZone::NonTessellatedLODSectionScale' has a wrong offset!");
static_assert(offsetof(AWaterZone, OverlapPriority) == 0x0002FC, "Member 'AWaterZone::OverlapPriority' has a wrong offset!");
static_assert(offsetof(AWaterZone, bEnableNonTessellatedLODMesh) == 0x000300, "Member 'AWaterZone::bEnableNonTessellatedLODMesh' has a wrong offset!");
