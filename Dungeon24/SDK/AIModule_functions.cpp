...
// (Final, Native, Public, BlueprintCallable, BlueprintPure, Const)
// Parameters:
// float                                   InAcceptanceRadius                                     (ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// bool                                    ReturnValue                                            (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

bool UPathFollowingComponent::CheckReachedDestination(const float InAcceptanceRadius) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("PathFollowingComponent", "CheckReachedDestination");

	Params::PathFollowingComponent_CheckReachedDestination Parms{};
...
void UAIPerceptionComponent::ForgetActor(class AActor* ActorToForget)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("AIPerceptionComponent", "ForgetActor");

	Params::AIPerceptionComponent_ForgetActor Parms{};
...
bool UAIPerceptionSystem::UnregisterPerceptionStimuliSource(class UObject* WorldContextObject, TSubclassOf<class UAISense> Sense, class AActor* Target)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = StaticClass()->GetFunction("AIPerceptionSystem", "UnregisterPerceptionStimuliSource");

	Params::AIPerceptionSystem_UnregisterPerceptionStimuliSource Parms{};
