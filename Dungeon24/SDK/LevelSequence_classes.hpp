...
static_assert(sizeof(ALevelSequenceActor) == 0x000310, "Wrong size on ALevelSequenceActor");
...
static_assert(offsetof(ALevelSequenceActor, SequencePlayer) == 0x0002C8, "Member 'ALevelSequenceActor::SequencePlayer' has a wrong offset!");
static_assert(offsetof(ALevelSequenceActor, LevelSequenceAsset) == 0x0002D0, "Member 'ALevelSequenceActor::LevelSequenceAsset' has a wrong offset!");
static_assert(offsetof(ALevelSequenceActor, CameraSettings) == 0x0002D8, "Member 'ALevelSequenceActor::CameraSettings' has a wrong offset!");
static_assert(offsetof(ALevelSequenceActor, BurnInOptions) == 0x0002E0, "Member 'ALevelSequenceActor::BurnInOptions' has a wrong offset!");
static_assert(offsetof(ALevelSequenceActor, BindingOverrides) == 0x0002E8, "Member 'ALevelSequenceActor::BindingOverrides' has a wrong offset!");
static_assert(offsetof(ALevelSequenceActor, DefaultInstanceData) == 0x0002F8, "Member 'ALevelSequenceActor::DefaultInstanceData' has a wrong offset!");
static_assert(offsetof(ALevelSequenceActor, BurnInInstance) == 0x000300, "Member 'ALevelSequenceActor::BurnInInstance' has a wrong offset!");
static_assert(offsetof(ALevelSequenceActor, bShowBurnin) == 0x000308, "Member 'ALevelSequenceActor::bShowBurnin' has a wrong offset!");
...
static_assert(sizeof(AReplicatedLevelSequenceActor) == 0x000310, "Wrong size on AReplicatedLevelSequenceActor");
