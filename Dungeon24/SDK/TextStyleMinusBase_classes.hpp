...
static_assert(alignof(UTextStyleMinusBase_C) == 0x000010, "Wrong alignment on UTextStyleMinusBase_C");
static_assert(sizeof(UTextStyleMinusBase_C) == 0x0001B0, "Wrong size on UTextStyleMinusBase_C");
