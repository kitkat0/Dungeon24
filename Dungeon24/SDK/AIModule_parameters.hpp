...
// Function AIModule.PathFollowingComponent.CheckReachedDestination
// 0x0008 (0x0008 - 0x0000)
struct PathFollowingComponent_CheckReachedDestination final
{
public:
	float                                         InAcceptanceRadius;                                // 0x0000(0x0004)(ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          ReturnValue;                                       // 0x0004(0x0001)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_5[0x3];                                        // 0x0005(0x0003)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(PathFollowingComponent_CheckReachedDestination) == 0x000004, "Wrong alignment on PathFollowingComponent_CheckReachedDestination");
static_assert(sizeof(PathFollowingComponent_CheckReachedDestination) == 0x000008, "Wrong size on PathFollowingComponent_CheckReachedDestination");
static_assert(offsetof(PathFollowingComponent_CheckReachedDestination, InAcceptanceRadius) == 0x000000, "Member 'PathFollowingComponent_CheckReachedDestination::InAcceptanceRadius' has a wrong offset!");
static_assert(offsetof(PathFollowingComponent_CheckReachedDestination, ReturnValue) == 0x000004, "Member 'PathFollowingComponent_CheckReachedDestination::ReturnValue' has a wrong offset!");
...
// Function AIModule.AIPerceptionComponent.ForgetActor
// 0x0008 (0x0008 - 0x0000)
struct AIPerceptionComponent_ForgetActor final
{
public:
...
static_assert(alignof(AIPerceptionComponent_ForgetActor) == 0x000008, "Wrong alignment on AIPerceptionComponent_ForgetActor");
static_assert(sizeof(AIPerceptionComponent_ForgetActor) == 0x000008, "Wrong size on AIPerceptionComponent_ForgetActor");
static_assert(offsetof(AIPerceptionComponent_ForgetActor, ActorToForget) == 0x000000, "Member 'AIPerceptionComponent_ForgetActor::ActorToForget' has a wrong offset!");
...
// Function AIModule.AIBlueprintHelperLibrary.CreateMoveToProxyObjectEx
// 0x0050 (0x0050 - 0x0000)
struct AIBlueprintHelperLibrary_CreateMoveToProxyObjectEx final
{
public:
	class UObject*                                WorldContextObject;                                // 0x0000(0x0008)(Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class APawn*                                  Pawn;                                              // 0x0008(0x0008)(Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	float                                         AcceptanceRadius;                                  // 0x0030(0x0004)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bStopOnOverlap;                                    // 0x0034(0x0001)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bUsePathfinding;                                   // 0x0035(0x0001)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bProjectDestinationToNavigation;                   // 0x0036(0x0001)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bCanStrafe;                                        // 0x0037(0x0001)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	class UAIAsyncTaskBlueprintProxy*             ReturnValue;                                       // 0x0048(0x0008)(Parm, OutParm, ZeroConstructor, ReturnParm, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(AIBlueprintHelperLibrary_CreateMoveToProxyObjectEx) == 0x000008, "Wrong alignment on AIBlueprintHelperLibrary_CreateMoveToProxyObjectEx");
static_assert(sizeof(AIBlueprintHelperLibrary_CreateMoveToProxyObjectEx) == 0x000050, "Wrong size on AIBlueprintHelperLibrary_CreateMoveToProxyObjectEx");
static_assert(offsetof(AIBlueprintHelperLibrary_CreateMoveToProxyObjectEx, WorldContextObject) == 0x000000, "Member 'AIBlueprintHelperLibrary_CreateMoveToProxyObjectEx::WorldContextObject' has a wrong offset!");
static_assert(offsetof(AIBlueprintHelperLibrary_CreateMoveToProxyObjectEx, Pawn) == 0x000008, "Member 'AIBlueprintHelperLibrary_CreateMoveToProxyObjectEx::Pawn' has a wrong offset!");
static_assert(offsetof(AIBlueprintHelperLibrary_CreateMoveToProxyObjectEx, Destination) == 0x000010, "Member 'AIBlueprintHelperLibrary_CreateMoveToProxyObjectEx::Destination' has a wrong offset!");
static_assert(offsetof(AIBlueprintHelperLibrary_CreateMoveToProxyObjectEx, TargetActor) == 0x000028, "Member 'AIBlueprintHelperLibrary_CreateMoveToProxyObjectEx::TargetActor' has a wrong offset!");
static_assert(offsetof(AIBlueprintHelperLibrary_CreateMoveToProxyObjectEx, AcceptanceRadius) == 0x000030, "Member 'AIBlueprintHelperLibrary_CreateMoveToProxyObjectEx::AcceptanceRadius' has a wrong offset!");
static_assert(offsetof(AIBlueprintHelperLibrary_CreateMoveToProxyObjectEx, bStopOnOverlap) == 0x000034, "Member 'AIBlueprintHelperLibrary_CreateMoveToProxyObjectEx::bStopOnOverlap' has a wrong offset!");
static_assert(offsetof(AIBlueprintHelperLibrary_CreateMoveToProxyObjectEx, bUsePathfinding) == 0x000035, "Member 'AIBlueprintHelperLibrary_CreateMoveToProxyObjectEx::bUsePathfinding' has a wrong offset!");
static_assert(offsetof(AIBlueprintHelperLibrary_CreateMoveToProxyObjectEx, bProjectDestinationToNavigation) == 0x000036, "Member 'AIBlueprintHelperLibrary_CreateMoveToProxyObjectEx::bProjectDestinationToNavigation' has a wrong offset!");
static_assert(offsetof(AIBlueprintHelperLibrary_CreateMoveToProxyObjectEx, bCanStrafe) == 0x000037, "Member 'AIBlueprintHelperLibrary_CreateMoveToProxyObjectEx::bCanStrafe' has a wrong offset!");
static_assert(offsetof(AIBlueprintHelperLibrary_CreateMoveToProxyObjectEx, FilterClass) == 0x000038, "Member 'AIBlueprintHelperLibrary_CreateMoveToProxyObjectEx::FilterClass' has a wrong offset!");
static_assert(offsetof(AIBlueprintHelperLibrary_CreateMoveToProxyObjectEx, bAllowPartialPath) == 0x000040, "Member 'AIBlueprintHelperLibrary_CreateMoveToProxyObjectEx::bAllowPartialPath' has a wrong offset!");
static_assert(offsetof(AIBlueprintHelperLibrary_CreateMoveToProxyObjectEx, ReturnValue) == 0x000048, "Member 'AIBlueprintHelperLibrary_CreateMoveToProxyObjectEx::ReturnValue' has a wrong offset!");
...
// Function AIModule.AIPerceptionSystem.UnregisterPerceptionStimuliSource
// 0x0020 (0x0020 - 0x0000)
struct AIPerceptionSystem_UnregisterPerceptionStimuliSource final
{
public:
	class UObject*                                WorldContextObject;                                // 0x0000(0x0008)(Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TSubclassOf<class UAISense>                   Sense;                                             // 0x0008(0x0008)(Parm, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(alignof(AIPerceptionSystem_UnregisterPerceptionStimuliSource) == 0x000008, "Wrong alignment on AIPerceptionSystem_UnregisterPerceptionStimuliSource");
static_assert(sizeof(AIPerceptionSystem_UnregisterPerceptionStimuliSource) == 0x000020, "Wrong size on AIPerceptionSystem_UnregisterPerceptionStimuliSource");
static_assert(offsetof(AIPerceptionSystem_UnregisterPerceptionStimuliSource, WorldContextObject) == 0x000000, "Member 'AIPerceptionSystem_UnregisterPerceptionStimuliSource::WorldContextObject' has a wrong offset!");
static_assert(offsetof(AIPerceptionSystem_UnregisterPerceptionStimuliSource, Sense) == 0x000008, "Member 'AIPerceptionSystem_UnregisterPerceptionStimuliSource::Sense' has a wrong offset!");
static_assert(offsetof(AIPerceptionSystem_UnregisterPerceptionStimuliSource, Target) == 0x000010, "Member 'AIPerceptionSystem_UnregisterPerceptionStimuliSource::Target' has a wrong offset!");
static_assert(offsetof(AIPerceptionSystem_UnregisterPerceptionStimuliSource, ReturnValue) == 0x000018, "Member 'AIPerceptionSystem_UnregisterPerceptionStimuliSource::ReturnValue' has a wrong offset!");
