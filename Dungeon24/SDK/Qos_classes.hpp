...
static_assert(sizeof(AQosBeaconClient) == 0x000360, "Wrong size on AQosBeaconClient");
...
static_assert(sizeof(AQosBeaconHost) == 0x0002D0, "Wrong size on AQosBeaconHost");
