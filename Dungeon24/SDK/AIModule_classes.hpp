...
public:
	...
	class UPawnActionsComponent*                  ActionsComp;                                       // 0x0388(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
public:
	...
	class UPawnAction*                            CurrentAction;                                     // 0x00D0(0x0008)(ZeroConstructor, Transient, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
public:
	...
	uint8                                         Pad_F8[0x1C8];                                     // 0x00F8(0x01C8)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	bool CheckReachedDestination(const float InAcceptanceRadius) const;
...
static_assert(sizeof(UPathFollowingComponent) == 0x0002C0, "Wrong size on UPathFollowingComponent");
...
public:
	...
	FMulticastInlineDelegateProperty_             OnTargetPerceptionUpdated;                         // 0x0168(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnTargetPerceptionInfoUpdated;                     // 0x0178(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)

public:
	void ForgetActor(class AActor* ActorToForget);
	void ForgetAll();
...
public:
	...
	static class UAIAsyncTaskBlueprintProxy* CreateMoveToProxyObjectEx(class UObject* WorldContextObject, class APawn* Pawn, const struct FVector& Destination, class AActor* TargetActor, float AcceptanceRadius, bool bStopOnOverlap, bool bUsePathfinding, bool bProjectDestinationToNavigation, bool bCanStrafe, TSubclassOf<class UNavigationQueryFilter> FilterClass, bool bAllowPartialPath);
...
public:
	...
	struct FVector                                CrowdAgentMoveDirection;                           // 0x02D8(0x0018)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UCrowdFollowingComponent) == 0x000310, "Wrong size on UCrowdFollowingComponent");
static_assert(offsetof(UCrowdFollowingComponent, CrowdAgentMoveDirection) == 0x0002D8, "Member 'UCrowdFollowingComponent::CrowdAgentMoveDirection' has a wrong offset!");
...
{
public:
	class UNavLocalGridManager*                   GridManager;                                       // 0x02C0(0x0008)(ZeroConstructor, Transient, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UGridPathFollowingComponent) == 0x0002F0, "Wrong size on UGridPathFollowingComponent");
static_assert(offsetof(UGridPathFollowingComponent, GridManager) == 0x0002C0, "Member 'UGridPathFollowingComponent::GridManager' has a wrong offset!");
