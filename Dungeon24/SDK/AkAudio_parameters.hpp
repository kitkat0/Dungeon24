...
// 0x0020 (0x0020 - 0x0000)
struct AkAudioEvent_ExecuteActionImp final
{
public:
	EAkActionOnEventType                          ActionType;                                        // 0x0000(0x0001)(ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_1[0x7];                                        // 0x0001(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	const class UAkComponent*                     Component;                                         // 0x0008(0x0008)(ConstParm, Parm, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         PlayingID;                                         // 0x0010(0x0004)(ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         TransitionDuration;                                // 0x0014(0x0004)(ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EAkCurveInterpolation                         FadeCurve;                                         // 0x0018(0x0001)(ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_19[0x3];                                       // 0x0019(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(AkAudioEvent_ExecuteActionImp) == 0x000008, "Wrong alignment on AkAudioEvent_ExecuteActionImp");
static_assert(sizeof(AkAudioEvent_ExecuteActionImp) == 0x000020, "Wrong size on AkAudioEvent_ExecuteActionImp");
static_assert(offsetof(AkAudioEvent_ExecuteActionImp, ActionType) == 0x000000, "Member 'AkAudioEvent_ExecuteActionImp::ActionType' has a wrong offset!");
static_assert(offsetof(AkAudioEvent_ExecuteActionImp, Component) == 0x000008, "Member 'AkAudioEvent_ExecuteActionImp::Component' has a wrong offset!");
static_assert(offsetof(AkAudioEvent_ExecuteActionImp, PlayingID) == 0x000010, "Member 'AkAudioEvent_ExecuteActionImp::PlayingID' has a wrong offset!");
static_assert(offsetof(AkAudioEvent_ExecuteActionImp, TransitionDuration) == 0x000014, "Member 'AkAudioEvent_ExecuteActionImp::TransitionDuration' has a wrong offset!");
static_assert(offsetof(AkAudioEvent_ExecuteActionImp, FadeCurve) == 0x000018, "Member 'AkAudioEvent_ExecuteActionImp::FadeCurve' has a wrong offset!");
static_assert(offsetof(AkAudioEvent_ExecuteActionImp, ReturnValue) == 0x00001C, "Member 'AkAudioEvent_ExecuteActionImp::ReturnValue' has a wrong offset!");
