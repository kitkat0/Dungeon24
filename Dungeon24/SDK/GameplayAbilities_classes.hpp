...
static_assert(sizeof(AAbilitySystemDebugHUD) == 0x000388, "Wrong size on AAbilitySystemDebugHUD");
...
public:
	...
	struct FGameplayTagContainer                  AbilityTags;                                       // 0x00A8(0x0020)(Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, NativeAccessSpecifierPublic)
	...
	struct FGameplayTagContainer                  ActivationOwnedNonReplicateTags;                   // 0x0230(0x0020)(Edit, DisableEditOnInstance, Protected, NativeAccessSpecifierProtected)
...
static_assert(offsetof(UGameplayAbility, ActivationOwnedNonReplicateTags) == 0x000230, "Member 'UGameplayAbility::ActivationOwnedNonReplicateTags' has a wrong offset!");
...
static_assert(offsetof(AGameplayAbilityTargetActor, ShouldProduceTargetDataOnServer) == 0x000298, "Member 'AGameplayAbilityTargetActor::ShouldProduceTargetDataOnServer' has a wrong offset!");
...
public:
	...
	class AActor*                                 TargetingActor;                                    // 0x02C0(0x0008)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(offsetof(AGameplayAbilityWorldReticle, Parameters) == 0x000298, "Member 'AGameplayAbilityWorldReticle::Parameters' has a wrong offset!");
static_assert(offsetof(AGameplayAbilityWorldReticle, bFaceOwnerFlat) == 0x0002B0, "Member 'AGameplayAbilityWorldReticle::bFaceOwnerFlat' has a wrong offset!");
static_assert(offsetof(AGameplayAbilityWorldReticle, bSnapToTargetedActor) == 0x0002B1, "Member 'AGameplayAbilityWorldReticle::bSnapToTargetedActor' has a wrong offset!");
static_assert(offsetof(AGameplayAbilityWorldReticle, bIsTargetValid) == 0x0002B2, "Member 'AGameplayAbilityWorldReticle::bIsTargetValid' has a wrong offset!");
static_assert(offsetof(AGameplayAbilityWorldReticle, bIsTargetAnActor) == 0x0002B3, "Member 'AGameplayAbilityWorldReticle::bIsTargetAnActor' has a wrong offset!");
static_assert(offsetof(AGameplayAbilityWorldReticle, PrimaryPC) == 0x0002B8, "Member 'AGameplayAbilityWorldReticle::PrimaryPC' has a wrong offset!");
...
public:
	...
	FMulticastInlineDelegateProperty_             OnNotifyBegin;                                     // 0x00C0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnNotifyEnd;                                       // 0x00D0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                         Pad_E0[0x30];                                      // 0x00E0(0x0030)(Fixing Size After Last Property [ Dumper-7 ])
	class UAnimMontage*                           MontageToPlay;                                     // 0x0110(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	float                                         Rate;                                              // 0x0118(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class FName                                   StartSection;                                      // 0x011C(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	float                                         AnimRootMotionTranslationScale;                    // 0x0124(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	float                                         StartTimeSeconds;                                  // 0x0128(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bStopWhenAbilityEnds;                              // 0x012C(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bDirectJumpSection;                                // 0x012D(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_12E[0x2];                                      // 0x012E(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         PlayMontageDelay;                                  // 0x0130(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UAbilityTask_PlayMontageAndWait) == 0x000138, "Wrong size on UAbilityTask_PlayMontageAndWait");
...
static_assert(offsetof(UAbilityTask_PlayMontageAndWait, OnNotifyBegin) == 0x0000C0, "Member 'UAbilityTask_PlayMontageAndWait::OnNotifyBegin' has a wrong offset!");
static_assert(offsetof(UAbilityTask_PlayMontageAndWait, OnNotifyEnd) == 0x0000D0, "Member 'UAbilityTask_PlayMontageAndWait::OnNotifyEnd' has a wrong offset!");
static_assert(offsetof(UAbilityTask_PlayMontageAndWait, MontageToPlay) == 0x000110, "Member 'UAbilityTask_PlayMontageAndWait::MontageToPlay' has a wrong offset!");
static_assert(offsetof(UAbilityTask_PlayMontageAndWait, Rate) == 0x000118, "Member 'UAbilityTask_PlayMontageAndWait::Rate' has a wrong offset!");
static_assert(offsetof(UAbilityTask_PlayMontageAndWait, StartSection) == 0x00011C, "Member 'UAbilityTask_PlayMontageAndWait::StartSection' has a wrong offset!");
static_assert(offsetof(UAbilityTask_PlayMontageAndWait, AnimRootMotionTranslationScale) == 0x000124, "Member 'UAbilityTask_PlayMontageAndWait::AnimRootMotionTranslationScale' has a wrong offset!");
static_assert(offsetof(UAbilityTask_PlayMontageAndWait, StartTimeSeconds) == 0x000128, "Member 'UAbilityTask_PlayMontageAndWait::StartTimeSeconds' has a wrong offset!");
static_assert(offsetof(UAbilityTask_PlayMontageAndWait, bStopWhenAbilityEnds) == 0x00012C, "Member 'UAbilityTask_PlayMontageAndWait::bStopWhenAbilityEnds' has a wrong offset!");
static_assert(offsetof(UAbilityTask_PlayMontageAndWait, bDirectJumpSection) == 0x00012D, "Member 'UAbilityTask_PlayMontageAndWait::bDirectJumpSection' has a wrong offset!");
static_assert(offsetof(UAbilityTask_PlayMontageAndWait, PlayMontageDelay) == 0x000130, "Member 'UAbilityTask_PlayMontageAndWait::PlayMontageDelay' has a wrong offset!");
...
public:
	...
	static void ExtendsGameplayEffectDuration(class AActor* Actor, const struct FActiveGameplayEffectHandle& Handle, float Duration, bool ForceSet);
	static void ExtendsGameplayEffectDurationByDef(class AActor* Actor, TSubclassOf<class UGameplayEffect> Def, float Duration, bool ForceSet);
	static void ExtendsGameplayEffectDurationByTag(class AActor* Actor, const struct FGameplayTag& AssetTag, float Duration, bool ForceSet);
	...
	static bool HasAllMatchingGameplayTags(class AActor* Actor, const struct FGameplayTagContainer& TagContainer);
	static bool HasAnyMatchingGameplayTags(class AActor* Actor, const struct FGameplayTagContainer& TagContainer);
	static bool HasHitResult(const struct FGameplayCueParameters& Parameters);
	static bool HasMatchingGameplayTag(class AActor* Actor, const struct FGameplayTag& TagToCheck);
	...
	static void SetLooseGameplayTagCount(class AActor* Actor, const struct FGameplayTagContainer& GameplayTags, int32 NewCount, bool bShouldReplicate);
...
public:
	...
	uint8                                         Pad_148[0x1A0];                                    // 0x0148(0x01A0)(Fixing Size After Last Property [ Dumper-7 ])
	...
	struct FGameplayAbilityLocalAnimMontage       LocalAnimMontageInfo;                              // 0x07C0(0x0038)(NoDestructor, Protected, NativeAccessSpecifierProtected)
	uint8                                         Pad_7F8[0xA0];                                     // 0x07F8(0x00A0)(Fixing Size After Last Property [ Dumper-7 ])
	struct FActiveGameplayEffectsContainer        ActiveGameplayEffects;                             // 0x0898(0x05B8)(Net, Protected, NativeAccessSpecifierProtected)
	struct FActiveGameplayCueContainer            ActiveGameplayCues;                                // 0x0E50(0x0128)(Net, ContainsInstancedReference, Protected, NativeAccessSpecifierProtected)
	struct FActiveGameplayCueContainer            MinimalReplicationGameplayCues;                    // 0x0F78(0x0128)(Net, ContainsInstancedReference, Protected, NativeAccessSpecifierProtected)
	uint8                                         Pad_10A0[0x128];                                   // 0x10A0(0x0128)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<uint8>                                 BlockedAbilityBindings;                            // 0x11C8(0x0010)(Net, ZeroConstructor, Transient, Protected, NativeAccessSpecifierProtected)
	uint8                                         Pad_11D8[0x128];                                   // 0x11D8(0x0128)(Fixing Size After Last Property [ Dumper-7 ])
	struct FMinimalReplicationTagCountMap         MinimalReplicationTags;                            // 0x1300(0x0060)(Net, ContainsInstancedReference, Protected, NativeAccessSpecifierProtected)
	TArray<class UAttributeSet*>                  SpawnedAttributes;                                 // 0x1360(0x0010)(ExportObject, Net, ZeroConstructor, RepNotify, ContainsInstancedReference, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
	uint8                                         Pad_1370[0x10];                                    // 0x1370(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	struct FMinimalReplicationTagCountMap         ReplicatedLooseTags;                               // 0x1380(0x0060)(Net, ContainsInstancedReference, NativeAccessSpecifierPrivate)
	uint8                                         Pad_13E0[0x8];                                     // 0x13E0(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	struct FReplicatedPredictionKeyMap            ReplicatedPredictionKeyMap;                        // 0x13E8(0x0118)(Net, NativeAccessSpecifierPublic)
...
public:
	...
	void CancelAbilities(const struct FGameplayTagContainer& WithTags, const struct FGameplayTagContainer& WithoutTags);
	void CancelAllAbilities(class UGameplayAbility* Ignore);
	...
	int32 RemoveActiveEffectsByClass(TSubclassOf<class UGameplayEffect> GameplayEffect);
...
static_assert(sizeof(UAbilitySystemComponent) == 0x001510, "Wrong size on UAbilitySystemComponent");
...
static_assert(offsetof(UAbilitySystemComponent, ActiveGameplayCues) == 0x000E50, "Member 'UAbilitySystemComponent::ActiveGameplayCues' has a wrong offset!");
static_assert(offsetof(UAbilitySystemComponent, MinimalReplicationGameplayCues) == 0x000F78, "Member 'UAbilitySystemComponent::MinimalReplicationGameplayCues' has a wrong offset!");
static_assert(offsetof(UAbilitySystemComponent, BlockedAbilityBindings) == 0x0011C8, "Member 'UAbilitySystemComponent::BlockedAbilityBindings' has a wrong offset!");
static_assert(offsetof(UAbilitySystemComponent, MinimalReplicationTags) == 0x001300, "Member 'UAbilitySystemComponent::MinimalReplicationTags' has a wrong offset!");
static_assert(offsetof(UAbilitySystemComponent, SpawnedAttributes) == 0x001360, "Member 'UAbilitySystemComponent::SpawnedAttributes' has a wrong offset!");
static_assert(offsetof(UAbilitySystemComponent, ReplicatedLooseTags) == 0x001380, "Member 'UAbilitySystemComponent::ReplicatedLooseTags' has a wrong offset!");
static_assert(offsetof(UAbilitySystemComponent, ReplicatedPredictionKeyMap) == 0x0013E8, "Member 'UAbilitySystemComponent::ReplicatedPredictionKeyMap' has a wrong offset!");
...
public:
	...
	TArray<float>                                 HitValueLevelThreshold;                            // 0x0268(0x0010)(ZeroConstructor, Config, Protected, NativeAccessSpecifierProtected)
	bool                                          IgnoreGCNWhenAttrNotFound;                         // 0x0278(0x0001)(ZeroConstructor, Config, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_279[0x37];                                     // 0x0279(0x0037)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UAbilitySystemGlobals) == 0x0002B0, "Wrong size on UAbilitySystemGlobals");
...
static_assert(offsetof(UAbilitySystemGlobals, HitValueLevelThreshold) == 0x000268, "Member 'UAbilitySystemGlobals::HitValueLevelThreshold' has a wrong offset!");
static_assert(offsetof(UAbilitySystemGlobals, IgnoreGCNWhenAttrNotFound) == 0x000278, "Member 'UAbilitySystemGlobals::IgnoreGCNWhenAttrNotFound' has a wrong offset!");
...
static_assert(sizeof(AAbilitySystemTestPawn) == 0x000368, "Wrong size on AAbilitySystemTestPawn");
static_assert(offsetof(AAbilitySystemTestPawn, AbilitySystemComponent) == 0x000360, "Member 'AAbilitySystemTestPawn::AbilitySystemComponent' has a wrong offset!");
...
public:
	...
	static void ExecuteNonReplicatedGameplayCueOnActor(class AActor* Target, const struct FGameplayTag& GameplayCueTag, const struct FGameplayCueParameters& Parameters);
...
public:
	...
	bool                                          bIgnoreForceGameplayCueNotifyTagCheckOnRemove;     // 0x02C0(0x0001)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_2C1[0x37];                                     // 0x02C1(0x0037)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(AGameplayCueNotify_Actor, bAutoDestroyOnRemove) == 0x000298, "Member 'AGameplayCueNotify_Actor::bAutoDestroyOnRemove' has a wrong offset!");
static_assert(offsetof(AGameplayCueNotify_Actor, AutoDestroyDelay) == 0x00029C, "Member 'AGameplayCueNotify_Actor::AutoDestroyDelay' has a wrong offset!");
static_assert(offsetof(AGameplayCueNotify_Actor, WarnIfTimelineIsStillRunning) == 0x0002A0, "Member 'AGameplayCueNotify_Actor::WarnIfTimelineIsStillRunning' has a wrong offset!");
static_assert(offsetof(AGameplayCueNotify_Actor, WarnIfLatentActionIsStillRunning) == 0x0002A1, "Member 'AGameplayCueNotify_Actor::WarnIfLatentActionIsStillRunning' has a wrong offset!");
static_assert(offsetof(AGameplayCueNotify_Actor, GameplayCueTag) == 0x0002A4, "Member 'AGameplayCueNotify_Actor::GameplayCueTag' has a wrong offset!");
static_assert(offsetof(AGameplayCueNotify_Actor, GameplayCueName) == 0x0002AC, "Member 'AGameplayCueNotify_Actor::GameplayCueName' has a wrong offset!");
static_assert(offsetof(AGameplayCueNotify_Actor, bAutoAttachToOwner) == 0x0002B4, "Member 'AGameplayCueNotify_Actor::bAutoAttachToOwner' has a wrong offset!");
static_assert(offsetof(AGameplayCueNotify_Actor, IsOverride) == 0x0002B5, "Member 'AGameplayCueNotify_Actor::IsOverride' has a wrong offset!");
static_assert(offsetof(AGameplayCueNotify_Actor, bUniqueInstancePerInstigator) == 0x0002B6, "Member 'AGameplayCueNotify_Actor::bUniqueInstancePerInstigator' has a wrong offset!");
static_assert(offsetof(AGameplayCueNotify_Actor, bUniqueInstancePerSourceObject) == 0x0002B7, "Member 'AGameplayCueNotify_Actor::bUniqueInstancePerSourceObject' has a wrong offset!");
static_assert(offsetof(AGameplayCueNotify_Actor, bAllowMultipleOnActiveEvents) == 0x0002B8, "Member 'AGameplayCueNotify_Actor::bAllowMultipleOnActiveEvents' has a wrong offset!");
static_assert(offsetof(AGameplayCueNotify_Actor, bAllowMultipleWhileActiveEvents) == 0x0002B9, "Member 'AGameplayCueNotify_Actor::bAllowMultipleWhileActiveEvents' has a wrong offset!");
static_assert(offsetof(AGameplayCueNotify_Actor, NumPreallocatedInstances) == 0x0002BC, "Member 'AGameplayCueNotify_Actor::NumPreallocatedInstances' has a wrong offset!");
static_assert(offsetof(AGameplayCueNotify_Actor, bIgnoreForceGameplayCueNotifyTagCheckOnRemove) == 0x0002C0, "Member 'AGameplayCueNotify_Actor::bIgnoreForceGameplayCueNotifyTagCheckOnRemove' has a wrong offset!");
...
// 0x0710 (0x0750 - 0x0040)
class UGameplayCueNotify_Burst final : public UGameplayCueNotify_Static
{
public:
	struct FGameplayCueNotify_SpawnCondition      DefaultSpawnCondition;                             // 0x0040(0x00D0)(Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, Protected, NativeAccessSpecifierProtected)
	struct FGameplayCueNotify_PlacementInfo       DefaultPlacementInfo;                              // 0x0110(0x0078)(Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, NoDestructor, Protected, NativeAccessSpecifierProtected)
	struct FGameplayCueNotify_BurstEffects        BurstEffects;                                      // 0x0188(0x05C8)(Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, Protected, NativeAccessSpecifierProtected)

public:
	void OnBurst(class AActor* Target, const struct FGameplayCueParameters& Parameters, const struct FGameplayCueNotify_SpawnResult& SpawnResults, bool NeedCulling) const;
...
static_assert(sizeof(UGameplayCueNotify_Burst) == 0x000750, "Wrong size on UGameplayCueNotify_Burst");
...
static_assert(offsetof(UGameplayCueNotify_Burst, DefaultPlacementInfo) == 0x000110, "Member 'UGameplayCueNotify_Burst::DefaultPlacementInfo' has a wrong offset!");
static_assert(offsetof(UGameplayCueNotify_Burst, BurstEffects) == 0x000188, "Member 'UGameplayCueNotify_Burst::BurstEffects' has a wrong offset!");

// Class GameplayAbilities.GameplayCueNotify_BurstLatent
// 0x0768 (0x0A60 - 0x02F8)
class AGameplayCueNotify_BurstLatent : public AGameplayCueNotify_Actor
{
public:
	struct FGameplayCueNotify_SpawnCondition      DefaultSpawnCondition;                             // 0x02F8(0x00D0)(Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, Protected, NativeAccessSpecifierProtected)
	struct FGameplayCueNotify_PlacementInfo       DefaultPlacementInfo;                              // 0x03C8(0x0078)(Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, NoDestructor, Protected, NativeAccessSpecifierProtected)
	struct FGameplayCueNotify_BurstEffects        BurstEffects;                                      // 0x0440(0x05C8)(Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, Protected, NativeAccessSpecifierProtected)
	struct FGameplayCueNotify_SpawnResult         BurstSpawnResults;                                 // 0x0A08(0x0058)(BlueprintVisible, BlueprintReadOnly, ContainsInstancedReference, Protected, NativeAccessSpecifierProtected)

public:
	void OnBurst(class AActor* Target, const struct FGameplayCueParameters& Parameters, const struct FGameplayCueNotify_SpawnResult& SpawnResults, bool NeedCulling);
...
static_assert(sizeof(AGameplayCueNotify_BurstLatent) == 0x000A60, "Wrong size on AGameplayCueNotify_BurstLatent");
...
static_assert(offsetof(AGameplayCueNotify_BurstLatent, DefaultPlacementInfo) == 0x0003C8, "Member 'AGameplayCueNotify_BurstLatent::DefaultPlacementInfo' has a wrong offset!");
static_assert(offsetof(AGameplayCueNotify_BurstLatent, BurstEffects) == 0x000440, "Member 'AGameplayCueNotify_BurstLatent::BurstEffects' has a wrong offset!");
static_assert(offsetof(AGameplayCueNotify_BurstLatent, BurstSpawnResults) == 0x000A08, "Member 'AGameplayCueNotify_BurstLatent::BurstSpawnResults' has a wrong offset!");
...
// 0x1858 (0x1B50 - 0x02F8)
class AGameplayCueNotify_Looping : public AGameplayCueNotify_Actor
{
public:
	struct FGameplayCueNotify_SpawnCondition      DefaultSpawnCondition;                             // 0x02F8(0x00D0)(Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, Protected, NativeAccessSpecifierProtected)
	struct FGameplayCueNotify_PlacementInfo       DefaultPlacementInfo;                              // 0x03C8(0x0078)(Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, NoDestructor, Protected, NativeAccessSpecifierProtected)
	struct FGameplayCueNotify_BurstEffects        ApplicationEffects;                                // 0x0440(0x05C8)(Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, Protected, NativeAccessSpecifierProtected)
	struct FGameplayCueNotify_SpawnResult         ApplicationSpawnResults;                           // 0x0A08(0x0058)(BlueprintVisible, BlueprintReadOnly, ContainsInstancedReference, Protected, NativeAccessSpecifierProtected)
	struct FGameplayCueNotify_LoopingEffects      LoopingEffects;                                    // 0x0A60(0x0450)(Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, Protected, NativeAccessSpecifierProtected)
	struct FGameplayCueNotify_SpawnResult         LoopingSpawnResults;                               // 0x0EB0(0x0058)(BlueprintVisible, BlueprintReadOnly, ContainsInstancedReference, Protected, NativeAccessSpecifierProtected)
	struct FGameplayCueNotify_BurstEffects        RecurringEffects;                                  // 0x0F08(0x05C8)(Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, Protected, NativeAccessSpecifierProtected)
	struct FGameplayCueNotify_SpawnResult         RecurringSpawnResults;                             // 0x14D0(0x0058)(BlueprintVisible, BlueprintReadOnly, ContainsInstancedReference, Protected, NativeAccessSpecifierProtected)
	struct FGameplayCueNotify_BurstEffects        RemovalEffects;                                    // 0x1528(0x05C8)(Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, Protected, NativeAccessSpecifierProtected)
	struct FGameplayCueNotify_SpawnResult         RemovalSpawnResults;                               // 0x1AF0(0x0058)(BlueprintVisible, BlueprintReadOnly, ContainsInstancedReference, Protected, NativeAccessSpecifierProtected)
	uint8                                         Pad_1B48[0x8];                                     // 0x1B48(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	void OnApplication(class AActor* Target, const struct FGameplayCueParameters& Parameters, const struct FGameplayCueNotify_SpawnResult& SpawnResults, bool NeedCulling);
	void OnLoopingStart(class AActor* Target, const struct FGameplayCueParameters& Parameters, const struct FGameplayCueNotify_SpawnResult& SpawnResults, bool NeedCulling);
	void OnRecurring(class AActor* Target, const struct FGameplayCueParameters& Parameters, const struct FGameplayCueNotify_SpawnResult& SpawnResults, bool NeedCulling);
	void OnRemoval(class AActor* Target, const struct FGameplayCueParameters& Parameters, const struct FGameplayCueNotify_SpawnResult& SpawnResults, bool NeedCulling);
...
static_assert(sizeof(AGameplayCueNotify_Looping) == 0x001B50, "Wrong size on AGameplayCueNotify_Looping");
...
static_assert(offsetof(AGameplayCueNotify_Looping, DefaultPlacementInfo) == 0x0003C8, "Member 'AGameplayCueNotify_Looping::DefaultPlacementInfo' has a wrong offset!");
static_assert(offsetof(AGameplayCueNotify_Looping, ApplicationEffects) == 0x000440, "Member 'AGameplayCueNotify_Looping::ApplicationEffects' has a wrong offset!");
static_assert(offsetof(AGameplayCueNotify_Looping, ApplicationSpawnResults) == 0x000A08, "Member 'AGameplayCueNotify_Looping::ApplicationSpawnResults' has a wrong offset!");
static_assert(offsetof(AGameplayCueNotify_Looping, LoopingEffects) == 0x000A60, "Member 'AGameplayCueNotify_Looping::LoopingEffects' has a wrong offset!");
static_assert(offsetof(AGameplayCueNotify_Looping, LoopingSpawnResults) == 0x000EB0, "Member 'AGameplayCueNotify_Looping::LoopingSpawnResults' has a wrong offset!");
static_assert(offsetof(AGameplayCueNotify_Looping, RecurringEffects) == 0x000F08, "Member 'AGameplayCueNotify_Looping::RecurringEffects' has a wrong offset!");
static_assert(offsetof(AGameplayCueNotify_Looping, RecurringSpawnResults) == 0x0014D0, "Member 'AGameplayCueNotify_Looping::RecurringSpawnResults' has a wrong offset!");
static_assert(offsetof(AGameplayCueNotify_Looping, RemovalEffects) == 0x001528, "Member 'AGameplayCueNotify_Looping::RemovalEffects' has a wrong offset!");
static_assert(offsetof(AGameplayCueNotify_Looping, RemovalSpawnResults) == 0x001AF0, "Member 'AGameplayCueNotify_Looping::RemovalSpawnResults' has a wrong offset!");
...
public:
	...
	bool                                          ForceSpawnGameplayCue;                             // 0x0860(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          ForceRefreshAttrOnStackNoChange;                   // 0x0861(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_862[0x6];                                      // 0x0862(0x0006)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	void OnStackChanged(class UAbilitySystemComponent* Target, class UAbilitySystemComponent* Source, int32 NewStackCount, int32 PreviousStackCount) const;
	void OnTimeChanged(class UAbilitySystemComponent* Target, class UAbilitySystemComponent* Source, float NewStartTime, float NewDuration) const;
...
static_assert(sizeof(UGameplayEffect) == 0x000868, "Wrong size on UGameplayEffect");
...
static_assert(offsetof(UGameplayEffect, ForceSpawnGameplayCue) == 0x000860, "Member 'UGameplayEffect::ForceSpawnGameplayCue' has a wrong offset!");
static_assert(offsetof(UGameplayEffect, ForceRefreshAttrOnStackNoChange) == 0x000861, "Member 'UGameplayEffect::ForceRefreshAttrOnStackNoChange' has a wrong offset!");
...
public:
	...
	TArray<struct FGameplayEffectAttributeCaptureDefinition> InvalidScopedModifierAttributes;                   // 0x0040(0x0010)(Edit, ZeroConstructor, DisableEditOnInstance, Protected, NativeAccessSpecifierProtected)
	struct FGameplayTagContainer                  ValidTransientAggregatorIdentifiers;               // 0x0050(0x0020)(Edit, DisableEditOnInstance, Protected, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UGameplayEffectExecutionCalculation) == 0x000070, "Wrong size on UGameplayEffectExecutionCalculation");
...
static_assert(offsetof(UGameplayEffectExecutionCalculation, InvalidScopedModifierAttributes) == 0x000040, "Member 'UGameplayEffectExecutionCalculation::InvalidScopedModifierAttributes' has a wrong offset!");
static_assert(offsetof(UGameplayEffectExecutionCalculation, ValidTransientAggregatorIdentifiers) == 0x000050, "Member 'UGameplayEffectExecutionCalculation::ValidTransientAggregatorIdentifiers' has a wrong offset!");
