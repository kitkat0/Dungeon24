...
// Class UMG.TickerUserWidget
// 0x0020 (0x0298 - 0x0278)
class UTickerUserWidget : public UUserWidget
{
public:
	uint8                                         bEnableInternalTick : 1;                           // 0x0278(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, DisableEditOnInstance, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected))
	uint8                                         Pad_279[0x3];                                      // 0x0279(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         InternalTickInterval;                              // 0x027C(0x0004)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	ESlateVisibility                              LastSlateVisibility;                               // 0x0280(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_281[0x17];                                     // 0x0281(0x0017)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	void BP_InternalTick(float InDeltaTime);
	bool InternalTick(float InDeltaTime);
	void ToggleInternalTick(bool StartTickFlag);

public:
	static class UClass* StaticClass()
	{
		return StaticClassImpl<"TickerUserWidget">();
	}
	static class UTickerUserWidget* GetDefaultObj()
	{
		return GetDefaultObjImpl<UTickerUserWidget>();
	}
};
static_assert(alignof(UTickerUserWidget) == 0x000008, "Wrong alignment on UTickerUserWidget");
static_assert(sizeof(UTickerUserWidget) == 0x000298, "Wrong size on UTickerUserWidget");
static_assert(offsetof(UTickerUserWidget, InternalTickInterval) == 0x00027C, "Member 'UTickerUserWidget::InternalTickInterval' has a wrong offset!");
static_assert(offsetof(UTickerUserWidget, LastSlateVisibility) == 0x000280, "Member 'UTickerUserWidget::LastSlateVisibility' has a wrong offset!");
...
// Class UMG.TooltipWidget
// 0x0000 (0x0028 - 0x0028)
class ITooltipWidget final : public IInterface
{
public:
...
public:
	...
	static class ITooltipWidget* GetDefaultObj()
	{
		return GetDefaultObjImpl<ITooltipWidget>();
	}
};
static_assert(alignof(ITooltipWidget) == 0x000008, "Wrong alignment on ITooltipWidget");
static_assert(sizeof(ITooltipWidget) == 0x000028, "Wrong size on ITooltipWidget");
