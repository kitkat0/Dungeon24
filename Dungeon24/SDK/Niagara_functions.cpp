...
TArray<class UMaterialInterface*> UNiagaraComponent::GetUsedMaterialsBP()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("NiagaraComponent", "GetUsedMaterialsBP");

	Params::NiagaraComponent_GetUsedMaterialsBP Parms{};
