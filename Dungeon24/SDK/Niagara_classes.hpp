...
public:
	...
	uint8                                         BitPad_28_2 : 6;                                   // 0x0028(0x0001)(Fixing Bit-Field Size For New Byte [ Dumper-7 ])
...
public:
	...
	TArray<class UMaterialInterface*> GetUsedMaterialsBP();
...
public:
	...
	bool                                          bFullscreenFX;                                     // 0x00B0(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UNiagaraEffectType) == 0x0000B8, "Wrong size on UNiagaraEffectType");
...
static_assert(offsetof(UNiagaraEffectType, bFullscreenFX) == 0x0000B0, "Member 'UNiagaraEffectType::bFullscreenFX' has a wrong offset!");
