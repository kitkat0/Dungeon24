...
// (Final, Native, Public, BlueprintCallable)
// Parameters:
// class UCanvasPanelSlot*                 CanvasSlot                                             (Parm, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
void UCommonUserWidget::SetOffsetsInCanvas(class UCanvasPanelSlot* CanvasSlot, float Left, float Top, float Right, float Bottom)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("CommonUserWidget", "SetOffsetsInCanvas");

	Params::CommonUserWidget_SetOffsetsInCanvas Parms{};
