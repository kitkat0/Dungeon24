...
static_assert(offsetof(UPointSetComponent, PointMaterial) == 0x000578, "Member 'UPointSetComponent::PointMaterial' has a wrong offset!");
static_assert(offsetof(UPointSetComponent, Bounds) == 0x000580, "Member 'UPointSetComponent::Bounds' has a wrong offset!");
static_assert(offsetof(UPointSetComponent, bBoundsDirty) == 0x0005B8, "Member 'UPointSetComponent::bBoundsDirty' has a wrong offset!");
...
static_assert(offsetof(UTriangleSetComponent, Bounds) == 0x000578, "Member 'UTriangleSetComponent::Bounds' has a wrong offset!");
static_assert(offsetof(UTriangleSetComponent, bBoundsDirty) == 0x0005B0, "Member 'UTriangleSetComponent::bBoundsDirty' has a wrong offset!");
...
static_assert(offsetof(UOctreeDynamicMeshComponent, MeshObject) == 0x000640, "Member 'UOctreeDynamicMeshComponent::MeshObject' has a wrong offset!");
...
static_assert(offsetof(ULineSetComponent, LineMaterial) == 0x000578, "Member 'ULineSetComponent::LineMaterial' has a wrong offset!");
static_assert(offsetof(ULineSetComponent, Bounds) == 0x000580, "Member 'ULineSetComponent::Bounds' has a wrong offset!");
static_assert(offsetof(ULineSetComponent, bBoundsDirty) == 0x0005B8, "Member 'ULineSetComponent::bBoundsDirty' has a wrong offset!");
...
public:
	...
	bool                                          bEnableColorSeams;                                 // 0x05B4(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_5B5[0x3];                                      // 0x05B5(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	struct FColor                                 ColorSeamColor;                                    // 0x05B8(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         ColorSeamThickness;                                // 0x05BC(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UMaterialInterface*                     LineMaterial;                                      // 0x05C0(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(offsetof(UMeshWireframeComponent, LineDepthBias) == 0x000578, "Member 'UMeshWireframeComponent::LineDepthBias' has a wrong offset!");
static_assert(offsetof(UMeshWireframeComponent, LineDepthBiasSizeScale) == 0x00057C, "Member 'UMeshWireframeComponent::LineDepthBiasSizeScale' has a wrong offset!");
static_assert(offsetof(UMeshWireframeComponent, ThicknessScale) == 0x000580, "Member 'UMeshWireframeComponent::ThicknessScale' has a wrong offset!");
static_assert(offsetof(UMeshWireframeComponent, bEnableWireframe) == 0x000584, "Member 'UMeshWireframeComponent::bEnableWireframe' has a wrong offset!");
static_assert(offsetof(UMeshWireframeComponent, WireframeColor) == 0x000588, "Member 'UMeshWireframeComponent::WireframeColor' has a wrong offset!");
static_assert(offsetof(UMeshWireframeComponent, WireframeThickness) == 0x00058C, "Member 'UMeshWireframeComponent::WireframeThickness' has a wrong offset!");
static_assert(offsetof(UMeshWireframeComponent, bEnableBoundaryEdges) == 0x000590, "Member 'UMeshWireframeComponent::bEnableBoundaryEdges' has a wrong offset!");
static_assert(offsetof(UMeshWireframeComponent, BoundaryEdgeColor) == 0x000594, "Member 'UMeshWireframeComponent::BoundaryEdgeColor' has a wrong offset!");
static_assert(offsetof(UMeshWireframeComponent, BoundaryEdgeThickness) == 0x000598, "Member 'UMeshWireframeComponent::BoundaryEdgeThickness' has a wrong offset!");
static_assert(offsetof(UMeshWireframeComponent, bEnableUVSeams) == 0x00059C, "Member 'UMeshWireframeComponent::bEnableUVSeams' has a wrong offset!");
static_assert(offsetof(UMeshWireframeComponent, UVSeamColor) == 0x0005A0, "Member 'UMeshWireframeComponent::UVSeamColor' has a wrong offset!");
static_assert(offsetof(UMeshWireframeComponent, UVSeamThickness) == 0x0005A4, "Member 'UMeshWireframeComponent::UVSeamThickness' has a wrong offset!");
static_assert(offsetof(UMeshWireframeComponent, bEnableNormalSeams) == 0x0005A8, "Member 'UMeshWireframeComponent::bEnableNormalSeams' has a wrong offset!");
static_assert(offsetof(UMeshWireframeComponent, NormalSeamColor) == 0x0005AC, "Member 'UMeshWireframeComponent::NormalSeamColor' has a wrong offset!");
static_assert(offsetof(UMeshWireframeComponent, NormalSeamThickness) == 0x0005B0, "Member 'UMeshWireframeComponent::NormalSeamThickness' has a wrong offset!");
static_assert(offsetof(UMeshWireframeComponent, bEnableColorSeams) == 0x0005B4, "Member 'UMeshWireframeComponent::bEnableColorSeams' has a wrong offset!");
static_assert(offsetof(UMeshWireframeComponent, ColorSeamColor) == 0x0005B8, "Member 'UMeshWireframeComponent::ColorSeamColor' has a wrong offset!");
static_assert(offsetof(UMeshWireframeComponent, ColorSeamThickness) == 0x0005BC, "Member 'UMeshWireframeComponent::ColorSeamThickness' has a wrong offset!");
static_assert(offsetof(UMeshWireframeComponent, LineMaterial) == 0x0005C0, "Member 'UMeshWireframeComponent::LineMaterial' has a wrong offset!");
static_assert(offsetof(UMeshWireframeComponent, LocalBounds) == 0x0005C8, "Member 'UMeshWireframeComponent::LocalBounds' has a wrong offset!");
