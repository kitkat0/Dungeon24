...
// Function CommonUI.CommonUserWidget.SetOffsetsInCanvas
// 0x0018 (0x0018 - 0x0000)
struct CommonUserWidget_SetOffsetsInCanvas final
{
public:
	class UCanvasPanelSlot*                       CanvasSlot;                                        // 0x0000(0x0008)(Parm, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	float                                         Right;                                             // 0x0010(0x0004)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         Bottom;                                            // 0x0014(0x0004)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(CommonUserWidget_SetOffsetsInCanvas) == 0x000008, "Wrong alignment on CommonUserWidget_SetOffsetsInCanvas");
static_assert(sizeof(CommonUserWidget_SetOffsetsInCanvas) == 0x000018, "Wrong size on CommonUserWidget_SetOffsetsInCanvas");
static_assert(offsetof(CommonUserWidget_SetOffsetsInCanvas, CanvasSlot) == 0x000000, "Member 'CommonUserWidget_SetOffsetsInCanvas::CanvasSlot' has a wrong offset!");
static_assert(offsetof(CommonUserWidget_SetOffsetsInCanvas, Left) == 0x000008, "Member 'CommonUserWidget_SetOffsetsInCanvas::Left' has a wrong offset!");
static_assert(offsetof(CommonUserWidget_SetOffsetsInCanvas, Top) == 0x00000C, "Member 'CommonUserWidget_SetOffsetsInCanvas::Top' has a wrong offset!");
static_assert(offsetof(CommonUserWidget_SetOffsetsInCanvas, Right) == 0x000010, "Member 'CommonUserWidget_SetOffsetsInCanvas::Right' has a wrong offset!");
static_assert(offsetof(CommonUserWidget_SetOffsetsInCanvas, Bottom) == 0x000014, "Member 'CommonUserWidget_SetOffsetsInCanvas::Bottom' has a wrong offset!");
