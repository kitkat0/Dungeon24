...
public:
	...
	uint8                                         Pad_31D[0x163];                                    // 0x031D(0x0163)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UAkComponent) == 0x000480, "Wrong size on UAkComponent");
...
public:
	...
	uint8                                         Pad_2A9[0xD7];                                     // 0x02A9(0x00D7)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UAkAudioInputComponent) == 0x0004B0, "Wrong size on UAkAudioInputComponent");
...
public:
	...
	class USoundSubmix*                           SubmixToRecord;                                    // 0x04B8(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UAkSubmixInputComponent, SubmixToRecord) == 0x0004B8, "Member 'UAkSubmixInputComponent::SubmixToRecord' has a wrong offset!");
...
public:
	...
	int32 ExecuteActionImp(const EAkActionOnEventType ActionType, const class UAkComponent* Component, const int32 PlayingID, const int32 TransitionDuration, const EAkCurveInterpolation FadeCurve);
...
public:
	...
	class UAkStateValue*                          InStateValue;                                      // 0x02D0(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UAkStateValue*                          OutStateValue;                                     // 0x02D8(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_2E0[0x8];                                      // 0x02E0(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	class UAkAuxBus*                              AuxBusManual;                                      // 0x02E8(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(offsetof(UAkLateReverbComponent, InStateValue) == 0x0002D0, "Member 'UAkLateReverbComponent::InStateValue' has a wrong offset!");
static_assert(offsetof(UAkLateReverbComponent, OutStateValue) == 0x0002D8, "Member 'UAkLateReverbComponent::OutStateValue' has a wrong offset!");
...
public:
	...
	TSoftObjectPtr<class UAkAuxBus>               DefaultReverbAuxBus;                               // 0x00E0(0x0030)(Edit, Config, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TMap<float, TSoftObjectPtr<class UAkAuxBus>>  EnvironmentDecayAuxBusMap;                         // 0x0110(0x0050)(Edit, Config, UObjectWrapper, NativeAccessSpecifierPublic)
	class FString                                 HFDampingName;                                     // 0x0160(0x0010)(Edit, ZeroConstructor, Config, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 DecayEstimateName;                                 // 0x0170(0x0010)(Edit, ZeroConstructor, Config, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 TimeToFirstReflectionName;                         // 0x0180(0x0010)(Edit, ZeroConstructor, Config, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TSoftObjectPtr<class UAkRtpc>                 HFDampingRTPC;                                     // 0x0190(0x0030)(Edit, Config, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TSoftObjectPtr<class UAkRtpc>                 DecayEstimateRTPC;                                 // 0x01C0(0x0030)(Edit, Config, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TSoftObjectPtr<class UAkRtpc>                 TimeToFirstReflectionRTPC;                         // 0x01F0(0x0030)(Edit, Config, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UAkSettings, EnvironmentDecayAuxBusMap) == 0x000110, "Member 'UAkSettings::EnvironmentDecayAuxBusMap' has a wrong offset!");
static_assert(offsetof(UAkSettings, HFDampingName) == 0x000160, "Member 'UAkSettings::HFDampingName' has a wrong offset!");
static_assert(offsetof(UAkSettings, DecayEstimateName) == 0x000170, "Member 'UAkSettings::DecayEstimateName' has a wrong offset!");
static_assert(offsetof(UAkSettings, TimeToFirstReflectionName) == 0x000180, "Member 'UAkSettings::TimeToFirstReflectionName' has a wrong offset!");
static_assert(offsetof(UAkSettings, HFDampingRTPC) == 0x000190, "Member 'UAkSettings::HFDampingRTPC' has a wrong offset!");
static_assert(offsetof(UAkSettings, DecayEstimateRTPC) == 0x0001C0, "Member 'UAkSettings::DecayEstimateRTPC' has a wrong offset!");
static_assert(offsetof(UAkSettings, TimeToFirstReflectionRTPC) == 0x0001F0, "Member 'UAkSettings::TimeToFirstReflectionRTPC' has a wrong offset!");
