...
public:
	...
	TMap<int32, struct FMovieSceneSequenceHierarchy> Hierarchies;                                       // 0x0128(0x0050)(NativeAccessSpecifierPrivate)
	TMap<int32, struct FMovieSceneEvaluationTemplate> TrackTemplates;                                    // 0x0178(0x0050)(ContainsInstancedReference, NativeAccessSpecifierPrivate)
	TMap<int32, struct FMovieSceneEvaluationField> TrackTemplateFields;                               // 0x01C8(0x0050)(NativeAccessSpecifierPrivate)
	TMap<int32, struct FMovieSceneEntityComponentField> EntityComponentFields;                             // 0x0218(0x0050)(NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UMovieSceneCompiledDataManager) == 0x000280, "Wrong size on UMovieSceneCompiledDataManager");
static_assert(offsetof(UMovieSceneCompiledDataManager, Hierarchies) == 0x000128, "Member 'UMovieSceneCompiledDataManager::Hierarchies' has a wrong offset!");
static_assert(offsetof(UMovieSceneCompiledDataManager, TrackTemplates) == 0x000178, "Member 'UMovieSceneCompiledDataManager::TrackTemplates' has a wrong offset!");
static_assert(offsetof(UMovieSceneCompiledDataManager, TrackTemplateFields) == 0x0001C8, "Member 'UMovieSceneCompiledDataManager::TrackTemplateFields' has a wrong offset!");
static_assert(offsetof(UMovieSceneCompiledDataManager, EntityComponentFields) == 0x000218, "Member 'UMovieSceneCompiledDataManager::EntityComponentFields' has a wrong offset!");
