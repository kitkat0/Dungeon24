...
public:
	...
	uint8                                         Pad_B8[0x4C0];                                     // 0x00B8(0x04C0)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UReplicationGraphNode_GridSpatialization2D) == 0x0002B0, "Wrong size on UReplicationGraphNode_GridSpatialization2D");
...
{
public:
	class UReplicationGraph*                      ReplicationGraph;                                  // 0x0298(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UNetReplicationGraphConnection*         ConnectionManager;                                 // 0x02A0(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(AReplicationGraphDebugActor) == 0x0002A8, "Wrong size on AReplicationGraphDebugActor");
static_assert(offsetof(AReplicationGraphDebugActor, ReplicationGraph) == 0x000298, "Member 'AReplicationGraphDebugActor::ReplicationGraph' has a wrong offset!");
static_assert(offsetof(AReplicationGraphDebugActor, ConnectionManager) == 0x0002A0, "Member 'AReplicationGraphDebugActor::ConnectionManager' has a wrong offset!");
