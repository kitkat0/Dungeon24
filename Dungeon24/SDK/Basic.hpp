...
namespace Offsets
{
	constexpr int32 GObjects = 0x097CAEB0;
	constexpr int32 AppendString = 0x03177DA0;
	constexpr int32 GNames = 0x0975B280;
	constexpr int32 GWorld = 0x09938BB8;
	constexpr int32 ProcessEvent = 0x03300B40;
