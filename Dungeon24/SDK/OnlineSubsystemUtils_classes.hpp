...
// 0x00F0 (0x3410 - 0x3320)
#pragma pack(push, 0x1)
class alignas(0x10) UIpConnection : public UNetConnection
{
public:
	uint8                                         Pad_3318[0xD4];                                    // 0x3318(0x00D4)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         SocketErrorDisconnectDelay;                        // 0x33EC(0x0004)(ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_33F0[0x18];                                    // 0x33F0(0x0018)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UIpConnection) == 0x003410, "Wrong size on UIpConnection");
static_assert(offsetof(UIpConnection, SocketErrorDisconnectDelay) == 0x0033EC, "Member 'UIpConnection::SocketErrorDisconnectDelay' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_7C0[0x88];                                     // 0x07C0(0x0088)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	bool                                          bAuthRequired;                                     // 0x02CC(0x0001)(ZeroConstructor, Config, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(offsetof(AOnlineBeaconHost, bAuthRequired) == 0x0002CC, "Member 'AOnlineBeaconHost::bAuthRequired' has a wrong offset!");
