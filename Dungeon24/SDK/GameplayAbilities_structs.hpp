...
enum class EGameplayAbilityInstancingPolicy : uint8
{
	...
	EGameplayAbilityInstancingPolicy_MAX     = 4,
};
...
enum class EGameplayEffectStackingExpirationPolicy : uint8
{
	...
	EGameplayEffectStackingExpirationPolicy_MAX = 4,
};
...
public:
	...
	struct FTagContainerAggregator                CapturedSourceTags;                                // 0x0060(0x0088)(NativeAccessSpecifierPublic)
	struct FTagContainerAggregator                CapturedTargetTags;                                // 0x00E8(0x0088)(NativeAccessSpecifierPublic)
...
public:
	...
	float                                         AdditionalDuration;                                // 0x02D4(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         ShowingAdditionalDuration;                         // 0x02D8(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         CachedAdditionalDuration;                          // 0x02DC(0x0004)(ZeroConstructor, IsPlainOldData, RepSkip, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bIsInhibited;                                      // 0x02E0(0x0001)(ZeroConstructor, IsPlainOldData, RepSkip, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_2E1[0x97];                                     // 0x02E1(0x0097)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FActiveGameplayEffect) == 0x000008, "Wrong alignment on FActiveGameplayEffect");
static_assert(sizeof(FActiveGameplayEffect) == 0x000378, "Wrong size on FActiveGameplayEffect");
...
static_assert(offsetof(FActiveGameplayEffect, AdditionalDuration) == 0x0002D4, "Member 'FActiveGameplayEffect::AdditionalDuration' has a wrong offset!");
static_assert(offsetof(FActiveGameplayEffect, ShowingAdditionalDuration) == 0x0002D8, "Member 'FActiveGameplayEffect::ShowingAdditionalDuration' has a wrong offset!");
static_assert(offsetof(FActiveGameplayEffect, CachedAdditionalDuration) == 0x0002DC, "Member 'FActiveGameplayEffect::CachedAdditionalDuration' has a wrong offset!");
static_assert(offsetof(FActiveGameplayEffect, bIsInhibited) == 0x0002E0, "Member 'FActiveGameplayEffect::bIsInhibited' has a wrong offset!");
...
static_assert(sizeof(FGameplayAbilityLocalAnimMontage) == 0x000038, "Wrong size on FGameplayAbilityLocalAnimMontage");
...
struct FGameplayAbilityContextForEffect final
{
public:
	TSet<class UAbilitySystemComponent*>          TriggeredASC;                                      // 0x0000(0x0050)(BlueprintVisible, ExportObject, BlueprintReadOnly, ContainsInstancedReference, NativeAccessSpecifierPublic)
	TWeakObjectPtr<class UGameplayAbility>        Ability;                                           // 0x0050(0x0008)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FGameplayAbilityContextForEffect) == 0x000008, "Wrong alignment on FGameplayAbilityContextForEffect");
static_assert(sizeof(FGameplayAbilityContextForEffect) == 0x000058, "Wrong size on FGameplayAbilityContextForEffect");
static_assert(offsetof(FGameplayAbilityContextForEffect, TriggeredASC) == 0x000000, "Member 'FGameplayAbilityContextForEffect::TriggeredASC' has a wrong offset!");
static_assert(offsetof(FGameplayAbilityContextForEffect, Ability) == 0x000050, "Member 'FGameplayAbilityContextForEffect::Ability' has a wrong offset!");
...
public:
	...
	TWeakObjectPtr<class UGameplayEffect>         Def;                                               // 0x00C0(0x0008)(BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FGameplayCueParameters) == 0x0000E0, "Wrong size on FGameplayCueParameters");
...
static_assert(offsetof(FGameplayCueParameters, Def) == 0x0000C0, "Member 'FGameplayCueParameters::Def' has a wrong offset!");
static_assert(offsetof(FGameplayCueParameters, GameplayEffectLevel) == 0x0000C8, "Member 'FGameplayCueParameters::GameplayEffectLevel' has a wrong offset!");
static_assert(offsetof(FGameplayCueParameters, AbilityLevel) == 0x0000CC, "Member 'FGameplayCueParameters::AbilityLevel' has a wrong offset!");
static_assert(offsetof(FGameplayCueParameters, TargetAttachComponent) == 0x0000D0, "Member 'FGameplayCueParameters::TargetAttachComponent' has a wrong offset!");
static_assert(offsetof(FGameplayCueParameters, bReplicateLocationWhenUsingMinimalRepProxy) == 0x0000D8, "Member 'FGameplayCueParameters::bReplicateLocationWhenUsingMinimalRepProxy' has a wrong offset!");
...
static_assert(sizeof(FGameplayCuePendingExecute) == 0x000198, "Wrong size on FGameplayCuePendingExecute");
...
public:
	...
	struct FPredictionKey                         PredictionKey;                                     // 0x0018(0x0018)(NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FGameplayCueParameters                 Parameters;                                        // 0x0030(0x00E0)(ContainsInstancedReference, NativeAccessSpecifierPublic)
	bool                                          bPredictivelyRemoved;                              // 0x0110(0x0001)(ZeroConstructor, IsPlainOldData, RepSkip, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_111[0x7];                                      // 0x0111(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FActiveGameplayCue) == 0x000008, "Wrong alignment on FActiveGameplayCue");
static_assert(sizeof(FActiveGameplayCue) == 0x000118, "Wrong size on FActiveGameplayCue");
...
static_assert(offsetof(FActiveGameplayCue, bPredictivelyRemoved) == 0x000110, "Member 'FActiveGameplayCue::bPredictivelyRemoved' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_140[0x450];                                    // 0x0140(0x0450)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class UGameplayEffect*>                ApplicationImmunityQueryEffects;                   // 0x0590(0x0010)(ZeroConstructor, RepSkip, UObjectWrapper, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(FActiveGameplayEffectsContainer) == 0x0005B8, "Wrong size on FActiveGameplayEffectsContainer");
...
static_assert(offsetof(FActiveGameplayEffectsContainer, ApplicationImmunityQueryEffects) == 0x000590, "Member 'FActiveGameplayEffectsContainer::ApplicationImmunityQueryEffects' has a wrong offset!");
...
public:
	...
	struct FGameplayTagQuery                      SourceAllowedTagQuery;                             // 0x0038(0x0048)(Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, NativeAccessSpecifierPublic)
	struct FGameplayTagQuery                      TargetAllowedTagQuery;                             // 0x0080(0x0048)(Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, NativeAccessSpecifierPublic)
	int32                                         RequiredHitValueLevel;                             // 0x00C8(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         RequiredEffectLevel;                               // 0x00CC(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FGameplayCueNotify_SpawnCondition) == 0x000008, "Wrong alignment on FGameplayCueNotify_SpawnCondition");
static_assert(sizeof(FGameplayCueNotify_SpawnCondition) == 0x0000D0, "Wrong size on FGameplayCueNotify_SpawnCondition");
...
static_assert(offsetof(FGameplayCueNotify_SpawnCondition, SourceAllowedTagQuery) == 0x000038, "Member 'FGameplayCueNotify_SpawnCondition::SourceAllowedTagQuery' has a wrong offset!");
static_assert(offsetof(FGameplayCueNotify_SpawnCondition, TargetAllowedTagQuery) == 0x000080, "Member 'FGameplayCueNotify_SpawnCondition::TargetAllowedTagQuery' has a wrong offset!");
static_assert(offsetof(FGameplayCueNotify_SpawnCondition, RequiredHitValueLevel) == 0x0000C8, "Member 'FGameplayCueNotify_SpawnCondition::RequiredHitValueLevel' has a wrong offset!");
static_assert(offsetof(FGameplayCueNotify_SpawnCondition, RequiredEffectLevel) == 0x0000CC, "Member 'FGameplayCueNotify_SpawnCondition::RequiredEffectLevel' has a wrong offset!");
...
public:
	...
	uint8                                         bAddLocationOffset : 1;                            // 0x000C(0x0001)(BitIndex: 0x02, PropSize: 0x0001 (Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	...
	struct FVector                                LocationOffset;                                    // 0x0040(0x0018)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector                                AttachmentOffset;                                  // 0x0058(0x0018)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          BlockAutoActivate;                                 // 0x0070(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FGameplayCueNotify_PlacementInfo) == 0x000078, "Wrong size on FGameplayCueNotify_PlacementInfo");
...
static_assert(offsetof(FGameplayCueNotify_PlacementInfo, LocationOffset) == 0x000040, "Member 'FGameplayCueNotify_PlacementInfo::LocationOffset' has a wrong offset!");
static_assert(offsetof(FGameplayCueNotify_PlacementInfo, AttachmentOffset) == 0x000058, "Member 'FGameplayCueNotify_PlacementInfo::AttachmentOffset' has a wrong offset!");
static_assert(offsetof(FGameplayCueNotify_PlacementInfo, BlockAutoActivate) == 0x000070, "Member 'FGameplayCueNotify_PlacementInfo::BlockAutoActivate' has a wrong offset!");
...
public:
	...
	class UNiagaraSystem*                         NiagaraSystem;                                     // 0x0148(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         bOverrideSpawnCondition : 1;                       // 0x0150(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bOverridePlacementInfo : 1;                        // 0x0150(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bCastShadow : 1;                                   // 0x0150(0x0001)(BitIndex: 0x02, PropSize: 0x0001 (Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
...
static_assert(sizeof(FGameplayCueNotify_ParticleInfo) == 0x000158, "Wrong size on FGameplayCueNotify_ParticleInfo");
...
static_assert(offsetof(FGameplayCueNotify_ParticleInfo, PlacementInfoOverride) == 0x0000D0, "Member 'FGameplayCueNotify_ParticleInfo::PlacementInfoOverride' has a wrong offset!");
static_assert(offsetof(FGameplayCueNotify_ParticleInfo, NiagaraSystem) == 0x000148, "Member 'FGameplayCueNotify_ParticleInfo::NiagaraSystem' has a wrong offset!");
...
public:
	struct FGameplayCueNotify_SpawnCondition      SpawnConditionOverride;                            // 0x0000(0x00D0)(Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, NativeAccessSpecifierPublic)
	struct FGameplayCueNotify_PlacementInfo       PlacementInfoOverride;                             // 0x00D0(0x0078)(Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, NoDestructor, NativeAccessSpecifierPublic)
	class USoundBase*                             Sound;                                             // 0x0148(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class USoundBase*                             SoundCue;                                          // 0x0150(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	float                                         LoopingFadeVolumeLevel;                            // 0x015C(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FGameplayCueNotify_SoundParameterInterfaceInfo SoundParameterInterfaceInfo;                       // 0x0160(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, NoDestructor, NativeAccessSpecifierPublic)
	...
	uint8                                         bUseSoundParameterInterface : 1;                   // 0x0168(0x0001)(BitIndex: 0x02, PropSize: 0x0001 (Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
...
static_assert(sizeof(FGameplayCueNotify_SoundInfo) == 0x000170, "Wrong size on FGameplayCueNotify_SoundInfo");
...
static_assert(offsetof(FGameplayCueNotify_SoundInfo, PlacementInfoOverride) == 0x0000D0, "Member 'FGameplayCueNotify_SoundInfo::PlacementInfoOverride' has a wrong offset!");
static_assert(offsetof(FGameplayCueNotify_SoundInfo, Sound) == 0x000148, "Member 'FGameplayCueNotify_SoundInfo::Sound' has a wrong offset!");
static_assert(offsetof(FGameplayCueNotify_SoundInfo, SoundCue) == 0x000150, "Member 'FGameplayCueNotify_SoundInfo::SoundCue' has a wrong offset!");
static_assert(offsetof(FGameplayCueNotify_SoundInfo, LoopingFadeOutDuration) == 0x000158, "Member 'FGameplayCueNotify_SoundInfo::LoopingFadeOutDuration' has a wrong offset!");
static_assert(offsetof(FGameplayCueNotify_SoundInfo, LoopingFadeVolumeLevel) == 0x00015C, "Member 'FGameplayCueNotify_SoundInfo::LoopingFadeVolumeLevel' has a wrong offset!");
static_assert(offsetof(FGameplayCueNotify_SoundInfo, SoundParameterInterfaceInfo) == 0x000160, "Member 'FGameplayCueNotify_SoundInfo::SoundParameterInterfaceInfo' has a wrong offset!");
...
static_assert(sizeof(FGameplayCueNotify_CameraShakeInfo) == 0x000168, "Wrong size on FGameplayCueNotify_CameraShakeInfo");
...
static_assert(offsetof(FGameplayCueNotify_CameraShakeInfo, PlacementInfoOverride) == 0x0000D0, "Member 'FGameplayCueNotify_CameraShakeInfo::PlacementInfoOverride' has a wrong offset!");
static_assert(offsetof(FGameplayCueNotify_CameraShakeInfo, CameraShake) == 0x000148, "Member 'FGameplayCueNotify_CameraShakeInfo::CameraShake' has a wrong offset!");
static_assert(offsetof(FGameplayCueNotify_CameraShakeInfo, ShakeScale) == 0x000150, "Member 'FGameplayCueNotify_CameraShakeInfo::ShakeScale' has a wrong offset!");
static_assert(offsetof(FGameplayCueNotify_CameraShakeInfo, PlaySpace) == 0x000154, "Member 'FGameplayCueNotify_CameraShakeInfo::PlaySpace' has a wrong offset!");
static_assert(offsetof(FGameplayCueNotify_CameraShakeInfo, WorldInnerRadius) == 0x00015C, "Member 'FGameplayCueNotify_CameraShakeInfo::WorldInnerRadius' has a wrong offset!");
static_assert(offsetof(FGameplayCueNotify_CameraShakeInfo, WorldOuterRadius) == 0x000160, "Member 'FGameplayCueNotify_CameraShakeInfo::WorldOuterRadius' has a wrong offset!");
static_assert(offsetof(FGameplayCueNotify_CameraShakeInfo, WorldFalloffExponent) == 0x000164, "Member 'FGameplayCueNotify_CameraShakeInfo::WorldFalloffExponent' has a wrong offset!");
...
public:
	struct FGameplayCueNotify_SpawnCondition      SpawnConditionOverride;                            // 0x0000(0x00D0)(Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, NativeAccessSpecifierPublic)
	struct FGameplayCueNotify_PlacementInfo       PlacementInfoOverride;                             // 0x00D0(0x0078)(Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, NoDestructor, NativeAccessSpecifierPublic)
	TSubclassOf<class AActor>                     CameraLensEffect;                                  // 0x0148(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         bOverrideSpawnCondition : 1;                       // 0x0150(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bOverridePlacementInfo : 1;                        // 0x0150(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bPlayInWorld : 1;                                  // 0x0150(0x0001)(BitIndex: 0x02, PropSize: 0x0001 (Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_151[0x3];                                      // 0x0151(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         WorldInnerRadius;                                  // 0x0154(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         WorldOuterRadius;                                  // 0x0158(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FGameplayCueNotify_CameraLensEffectInfo) == 0x000160, "Wrong size on FGameplayCueNotify_CameraLensEffectInfo");
...
static_assert(offsetof(FGameplayCueNotify_CameraLensEffectInfo, PlacementInfoOverride) == 0x0000D0, "Member 'FGameplayCueNotify_CameraLensEffectInfo::PlacementInfoOverride' has a wrong offset!");
static_assert(offsetof(FGameplayCueNotify_CameraLensEffectInfo, CameraLensEffect) == 0x000148, "Member 'FGameplayCueNotify_CameraLensEffectInfo::CameraLensEffect' has a wrong offset!");
static_assert(offsetof(FGameplayCueNotify_CameraLensEffectInfo, WorldInnerRadius) == 0x000154, "Member 'FGameplayCueNotify_CameraLensEffectInfo::WorldInnerRadius' has a wrong offset!");
static_assert(offsetof(FGameplayCueNotify_CameraLensEffectInfo, WorldOuterRadius) == 0x000158, "Member 'FGameplayCueNotify_CameraLensEffectInfo::WorldOuterRadius' has a wrong offset!");
...
public:
	struct FGameplayCueNotify_SpawnCondition      SpawnConditionOverride;                            // 0x0000(0x00D0)(Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, NativeAccessSpecifierPublic)
	struct FGameplayCueNotify_PlacementInfo       PlacementInfoOverride;                             // 0x00D0(0x0078)(Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, NoDestructor, NativeAccessSpecifierPublic)
	class UForceFeedbackEffect*                   ForceFeedbackEffect;                               // 0x0148(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FName                                   ForceFeedbackTag;                                  // 0x0150(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         bIsLooping : 1;                                    // 0x0158(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bOverrideSpawnCondition : 1;                       // 0x0158(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bOverridePlacementInfo : 1;                        // 0x0158(0x0001)(BitIndex: 0x02, PropSize: 0x0001 (Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bPlayInWorld : 1;                                  // 0x0158(0x0001)(BitIndex: 0x03, PropSize: 0x0001 (Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_159[0x3];                                      // 0x0159(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         WorldIntensity;                                    // 0x015C(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UForceFeedbackAttenuation*              WorldAttenuation;                                  // 0x0160(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(FGameplayCueNotify_ForceFeedbackInfo) == 0x000168, "Wrong size on FGameplayCueNotify_ForceFeedbackInfo");
...
static_assert(offsetof(FGameplayCueNotify_ForceFeedbackInfo, PlacementInfoOverride) == 0x0000D0, "Member 'FGameplayCueNotify_ForceFeedbackInfo::PlacementInfoOverride' has a wrong offset!");
static_assert(offsetof(FGameplayCueNotify_ForceFeedbackInfo, ForceFeedbackEffect) == 0x000148, "Member 'FGameplayCueNotify_ForceFeedbackInfo::ForceFeedbackEffect' has a wrong offset!");
static_assert(offsetof(FGameplayCueNotify_ForceFeedbackInfo, ForceFeedbackTag) == 0x000150, "Member 'FGameplayCueNotify_ForceFeedbackInfo::ForceFeedbackTag' has a wrong offset!");
static_assert(offsetof(FGameplayCueNotify_ForceFeedbackInfo, WorldIntensity) == 0x00015C, "Member 'FGameplayCueNotify_ForceFeedbackInfo::WorldIntensity' has a wrong offset!");
static_assert(offsetof(FGameplayCueNotify_ForceFeedbackInfo, WorldAttenuation) == 0x000160, "Member 'FGameplayCueNotify_ForceFeedbackInfo::WorldAttenuation' has a wrong offset!");
...
public:
	struct FGameplayCueNotify_SpawnCondition      SpawnConditionOverride;                            // 0x0000(0x00D0)(Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, NativeAccessSpecifierPublic)
	struct FGameplayCueNotify_PlacementInfo       PlacementInfoOverride;                             // 0x00D0(0x0078)(Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, NoDestructor, NativeAccessSpecifierPublic)
	class UMaterialInterface*                     DecalMaterial;                                     // 0x0148(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector                                DecalSize;                                         // 0x0150(0x0018)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         bOverrideSpawnCondition : 1;                       // 0x0168(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bOverridePlacementInfo : 1;                        // 0x0168(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bOverrideFadeOut : 1;                              // 0x0168(0x0001)(BitIndex: 0x02, PropSize: 0x0001 (Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_169[0x3];                                      // 0x0169(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         FadeOutStartDelay;                                 // 0x016C(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         FadeOutDuration;                                   // 0x0170(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FGameplayCueNotify_DecalInfo) == 0x000178, "Wrong size on FGameplayCueNotify_DecalInfo");
...
static_assert(offsetof(FGameplayCueNotify_DecalInfo, PlacementInfoOverride) == 0x0000D0, "Member 'FGameplayCueNotify_DecalInfo::PlacementInfoOverride' has a wrong offset!");
static_assert(offsetof(FGameplayCueNotify_DecalInfo, DecalMaterial) == 0x000148, "Member 'FGameplayCueNotify_DecalInfo::DecalMaterial' has a wrong offset!");
static_assert(offsetof(FGameplayCueNotify_DecalInfo, DecalSize) == 0x000150, "Member 'FGameplayCueNotify_DecalInfo::DecalSize' has a wrong offset!");
static_assert(offsetof(FGameplayCueNotify_DecalInfo, FadeOutStartDelay) == 0x00016C, "Member 'FGameplayCueNotify_DecalInfo::FadeOutStartDelay' has a wrong offset!");
static_assert(offsetof(FGameplayCueNotify_DecalInfo, FadeOutDuration) == 0x000170, "Member 'FGameplayCueNotify_DecalInfo::FadeOutDuration' has a wrong offset!");
...
public:
	...
	struct FGameplayCueNotify_CameraShakeInfo     BurstCameraShake;                                  // 0x0020(0x0168)(Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, Protected, NativeAccessSpecifierProtected)
	struct FGameplayCueNotify_CameraLensEffectInfo BurstCameraLensEffect;                             // 0x0188(0x0160)(Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, Protected, NativeAccessSpecifierProtected)
	struct FGameplayCueNotify_ForceFeedbackInfo   BurstForceFeedback;                                // 0x02E8(0x0168)(Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, Protected, NativeAccessSpecifierProtected)
	struct FGameplayCueNotify_DecalInfo           BurstDecal;                                        // 0x0450(0x0178)(Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, Protected, NativeAccessSpecifierProtected)
};
static_assert(alignof(FGameplayCueNotify_BurstEffects) == 0x000008, "Wrong alignment on FGameplayCueNotify_BurstEffects");
static_assert(sizeof(FGameplayCueNotify_BurstEffects) == 0x0005C8, "Wrong size on FGameplayCueNotify_BurstEffects");
...
static_assert(offsetof(FGameplayCueNotify_BurstEffects, BurstCameraLensEffect) == 0x000188, "Member 'FGameplayCueNotify_BurstEffects::BurstCameraLensEffect' has a wrong offset!");
static_assert(offsetof(FGameplayCueNotify_BurstEffects, BurstForceFeedback) == 0x0002E8, "Member 'FGameplayCueNotify_BurstEffects::BurstForceFeedback' has a wrong offset!");
static_assert(offsetof(FGameplayCueNotify_BurstEffects, BurstDecal) == 0x000450, "Member 'FGameplayCueNotify_BurstEffects::BurstDecal' has a wrong offset!");
...
public:
	...
	struct FGameplayCueNotify_CameraShakeInfo     LoopingCameraShake;                                // 0x0020(0x0168)(Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, Protected, NativeAccessSpecifierProtected)
	struct FGameplayCueNotify_CameraLensEffectInfo LoopingCameraLensEffect;                           // 0x0188(0x0160)(Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, Protected, NativeAccessSpecifierProtected)
	struct FGameplayCueNotify_ForceFeedbackInfo   LoopingForceFeedback;                              // 0x02E8(0x0168)(Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, Protected, NativeAccessSpecifierProtected)
};
static_assert(alignof(FGameplayCueNotify_LoopingEffects) == 0x000008, "Wrong alignment on FGameplayCueNotify_LoopingEffects");
static_assert(sizeof(FGameplayCueNotify_LoopingEffects) == 0x000450, "Wrong size on FGameplayCueNotify_LoopingEffects");
...
static_assert(offsetof(FGameplayCueNotify_LoopingEffects, LoopingCameraLensEffect) == 0x000188, "Member 'FGameplayCueNotify_LoopingEffects::LoopingCameraLensEffect' has a wrong offset!");
static_assert(offsetof(FGameplayCueNotify_LoopingEffects, LoopingForceFeedback) == 0x0002E8, "Member 'FGameplayCueNotify_LoopingEffects::LoopingForceFeedback' has a wrong offset!");
...
public:
	...
	struct FGameplayTagContainer                  GameplayCueTags;                                   // 0x0040(0x0020)(Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, NativeAccessSpecifierPublic)
	bool                                          ForceSpawn;                                        // 0x0060(0x0001)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_61[0x7];                                       // 0x0061(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FGameplayEffectCue) == 0x000008, "Wrong alignment on FGameplayEffectCue");
static_assert(sizeof(FGameplayEffectCue) == 0x000068, "Wrong size on FGameplayEffectCue");
...
static_assert(offsetof(FGameplayEffectCue, ForceSpawn) == 0x000060, "Member 'FGameplayEffectCue::ForceSpawn' has a wrong offset!");
...
public:
	...
	struct FVector                                WorldOrigin;                                       // 0x0070(0x0018)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         bHasWorldOrigin : 1;                               // 0x0088(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected))
	uint8                                         bReplicateSourceObject : 1;                        // 0x0088(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected))
	uint8                                         Pad_89[0x7];                                       // 0x0089(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FGameplayEffectContext) == 0x000008, "Wrong alignment on FGameplayEffectContext");
static_assert(sizeof(FGameplayEffectContext) == 0x000090, "Wrong size on FGameplayEffectContext");
...
static_assert(offsetof(FGameplayEffectContext, AbilityLevel) == 0x000038, "Member 'FGameplayEffectContext::AbilityLevel' has a wrong offset!");
static_assert(offsetof(FGameplayEffectContext, SourceObject) == 0x00003C, "Member 'FGameplayEffectContext::SourceObject' has a wrong offset!");
static_assert(offsetof(FGameplayEffectContext, InstigatorAbilitySystemComponent) == 0x000044, "Member 'FGameplayEffectContext::InstigatorAbilitySystemComponent' has a wrong offset!");
static_assert(offsetof(FGameplayEffectContext, Actors) == 0x000050, "Member 'FGameplayEffectContext::Actors' has a wrong offset!");
static_assert(offsetof(FGameplayEffectContext, WorldOrigin) == 0x000070, "Member 'FGameplayEffectContext::WorldOrigin' has a wrong offset!");
